...
**Visitor** - View info page, View Gallery, Donate, RequestProstetic, Like a Picture.
...
A visitor 
- can request for a prosthetic. Then the visitor needs to fill in a form, which can be reached by a link in the menu,  where the name, email-address and sort of prosthetic is filled in. 
...
- to donate a prosthetic, money or attention/advertisement he/she fill in a form which can be found at the donate link in the menu of the site. The visitor needs to fill in a name, email address
    maybe a telephone number and the visitor can choose by a select list what the visitor wants to donate. 
- goto the public gallery page which can also be found with a link on the menu of the site. The images will be sorted with the latest one first. 
...
- Like a picture. When a visitor likes a picture, he/she can click on a like button. 
...
**Artist** - Apply to be part of this project so the artist can paint a prosthetic.
...
A admin can 
-  give an artist wants has applied to become a "Professional Artist" on the site/app the right to become a  "Professional Artist".
- Managing request from a amputee means that  the admin sees the request.
- View artist submissions. When a artist sends in the apply form, there must be 2 pictures of art the artist made. These are stored in a database. 
...
When a request is pendng for more then  4 weeks, the system should send a email that the request is received but that the submission is on a waiting list. 
